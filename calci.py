...
def add_to_calculation(symbol):
    ...
    text_result.delete(1.0, "end") # specify 1.0 as start and end with string end
...
root= tk.Tk() # Tk() function used to intialize the tkinder & creates root window

# after creating root window can add various GUI elements
